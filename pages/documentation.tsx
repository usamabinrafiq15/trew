      ...
      <div className="docmentation">
        <Container>
          <div className="doc_heading">
            <div>
              <div className="doc_title"> Documentations</div>
            </div>
          </div>
          ...
          <div className="content">
            <div id="lorem1">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Introduction</div>
                <p>
            ...
            <div id="lorem2">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Analistics</div>
                <p>
                  JavaScript is a cross-platform, object-oriented scripting
                  language. It is a small and lightweight language. Inside a
                  host environment (for example, a web browser), JavaScript can
            ...
            <div id="lorem3">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Source</div>
                <p>
                  JavaScript is a cross-platform, object-oriented scripting
                  language. It is a small and lightweight language. Inside a
                  host environment (for example, a web browser), JavaScript can
            ...
            <div id="lorem4">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Development</div>
                <p>
                  JavaScript is a cross-platform, object-oriented scripting
                  language. It is a small and lightweight language. Inside a
                  host environment (for example, a web browser), JavaScript can
            ...
            <div id="lorem5">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Summary</div>
                <p>
                  JavaScript is a cross-platform, object-oriented scripting
                  language. It is a small and lightweight language. Inside a
                  host environment (for example, a web browser), JavaScript can
            ...
            <div id="lorem6">
              <div className="main-section" id="Introduction">
                <div className="doc_header-title">Index</div>
                <p>
                  JavaScript is a cross-platform, object-oriented scripting
                  language. It is a small and lightweight language. Inside a
                  host environment (for example, a web browser), JavaScript can
